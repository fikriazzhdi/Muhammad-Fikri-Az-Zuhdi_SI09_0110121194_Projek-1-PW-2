...
<!-- 
echo '<br/>Total : ' .$pasien1->nilaibmi();
echo '<br/>Status : ' .$pasien1->status();
$pasien1 = new bmipasien("22 Januari");
$pasien1->bmipasien();

$pasien2 = new pasien("P002","Rina");
$pasien2->pasien();
$pasien2 = new bmi("50", "160");
$pasien2->bmi();
echo '<br/>Total : ' .$pasien2->nilaibmi();
echo '<br/>Status : ' .$pasien2->status();
$pasien2 = new bmipasien("23 Januari");
$pasien2->bmipasien(); -->